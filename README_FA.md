...
- [هماهنگی با روزنوشت ابسیدین](#daily_notes)
...
## <a name="daily_notes"></a> هماهنگی با روزنوشت ابسیدین

گزینهٔ اختیاری **استفاده از تنظیمات روزنوشت ابسیدین** به‌طور پیش‌فرض غیرفعال است. با فعال کردن آن،
تقویم فارسی از پوشه، فرمت نام فایل و قالب روزنوشت ابسیدین استفاده می‌کند تا ابسیدین، تقویم فارسی و
افزونه‌های تقویم سازگار، روزنوشت‌های یکسانی را به اشتراک بگذارند. در این حالت، مسیر و قالب روزنوشت
تقویم فارسی نادیده گرفته می‌شوند. هفته‌نوشت‌ها، ماه‌نوشت‌ها، فصل‌نوشت‌ها و سال‌نوشت‌ها تغییری
نمی‌کنند.
