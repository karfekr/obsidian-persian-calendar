...
<div dir="rtl">
براکت‌ها به مسیریاب می‌گویند که محتوای داخل آن باید به‌عنوان یک نام ثابت در نظر گرفته شود:

Daily → به‌صورت D + aily تفسیر می‌شود.

[Daily] → به‌صورت نام ثابت Daily تفسیر می‌شود.
