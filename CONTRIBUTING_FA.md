...
همین حالا که این متن را می‌نویسم این پروژه **بیش از ۸ هزار کاربر فعال** دارد؛ یعنی هر باگ فیکس، هر
...
4. در نهایت Pull Request را باز کنید و در توضیحات آن دقیقاً بنویسید چه مسئله‌ای را حل می‌کند.
