...
همین حالا که این متن را می‌نویسم این پروژه **بیش از ۹هزار دانلود** دارد؛ یعنی هر باگ فیکس، هر
...
> تمام قالب‌های مربوط به فرمت کد توسط **editorconfig** و **prettierrc** و **esbuild.config.mjs** و…
> مشخص شده‌اند. از شما درخواست می‌کنیم **این چهارچوب را تغییر ندهید** و کد خود را با همان
> استانداردها ارائه دهید.
