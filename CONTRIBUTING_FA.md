...
همین حالا که این متن را می‌نویسم این پروژه **بیش از ۱۰هزار دانلود** دارد؛ یعنی هر باگ فیکس، هر
...
> تمام قالب‌های مربوط به فرمت کد توسط **editorconfig** و **biome.json** و…
